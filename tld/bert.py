...
def main(
    ...
    print(f'Dataset contains {label_feature.num_classes} classes')
    ...
    run_training_output_dir = train_output_dir / run_name
    ...
    test_output_dir = train_results_dir / run_name
    ...
    np.savez(
        ...
        labels=test_output.labels.numpy(),
        logits=test_output.logits.numpy(),
        last_hidden_states=test_output.last_hidden_states.numpy(),
    )
